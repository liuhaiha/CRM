...
class DBFHeader {
	...
	void read(DataInput dataInput, String characterSetName) throws IOException {
		...
		for (DBFField field = DBFField.createField(dataInput, characterSetName); field != null; field = DBFField.createField(dataInput, characterSetName)) {
	...
	void write(DataOutput dataOutput, String characterSetName) throws IOException {
		...
		for (int i = 0; i < fieldArray.length; i++) {
			...
			fieldArray[i].write(dataOutput, characterSetName);
		}
