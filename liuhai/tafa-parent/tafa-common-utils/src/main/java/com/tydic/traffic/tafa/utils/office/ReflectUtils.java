...
public class ReflectUtils {
	 ...
	 * 调用Setter方法.使用value的Class来查找Setter方法.
	 */
	public static void invokeSetterMethod(Object target, String[] propertyNames, Object[] values) {
	...
	/**
	 * 
	 * matchType:(根据Field和传入值，进行属性匹配传值). <br/>
	 * @param type
	 * @param s
	 * @return Object
	 * @since 1.0
	...
	public static Object matchType(Field type, String s) {
		...
		if (type.getGenericType() instanceof Class<?>) {
			...
			else if (java.lang.Byte.class.isAssignableFrom(cls)) {
				obj = Byte.valueOf(s);
			}
