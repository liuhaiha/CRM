...
public class DBFField {
	 ...
	 */
	protected static DBFField createField(DataInput in, String characterSetName) throws IOException {
		...
		field.name = new String(field.fieldName, 0, field.nameNullIndex, characterSetName);
	 ...
	 */
	protected void write(DataOutput out, String characterSetName) throws IOException {

		// DataOutputStream out = new DataOutputStream( os);
		
		this.fieldName = this.name.getBytes(characterSetName);
		if((this.fieldName.length == 0) || (this.fieldName.length > 10)){
			throw new IllegalArgumentException("Field name '" + this.name + "' should be of length 0-10.");
		}
